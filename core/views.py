            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address1, shipping_country, shipping_zip]):
                        ...
                        messages.info(self.request, "please enter the shipping address fields.")
                ...
                if same_billing_address:
                    ...
                    if is_valid_form([billing_address1,billing_address2,billing_zip]):
                        ...
                        messages.info(self.request, "please enter the billing address fields.")
    ...
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            if userprofile.one_click_purchasing:
                # fecting the user card list
                # cards = stripe.Customer.retrieve(
                cards = stripe.Customer.retrieve_source(
                    nested_id=userprofile.stripe_customer_id,
        ...
        if form.is_valid():
            ...
            if save:
                if userprofile.stripe_customer_id != '' and userprofile.stripe_customer_id is not None:
                    ...
                    stripe.Customer.create_source(source=token)
